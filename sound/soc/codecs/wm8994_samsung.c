...
char *playback_path_name[] = {"OFF", "RCV", "SPK", "HP", "3POLE", "BT", "SPK_HP", "EXTRA_DOCK_SPEAKER", };
	...
	struct snd_ctl_elem_value *ucontrol)
{
	...
	switch(control_data)
	{
        ...
        case CMD_CODEC_LOOPBACK_TEST : 
            DEBUG_LOG("[WM8994] CMD_CODEC_LOOPBACK_TEST");
            Earset_Loopback_Chk = 1;
			break;

		default :
            printk("[WM8994] Unkown codec control data : %d\n", control_data);
			break;
	}
